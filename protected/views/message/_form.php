...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'del1'); ?>
		<?php echo $form->textField($model,'del1'); ?>
		<?php echo $form->error($model,'del1'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'del2'); ?>
		<?php echo $form->textField($model,'del2'); ?>
		<?php echo $form->error($model,'del2'); ?>
	</div>
